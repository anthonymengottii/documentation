---
title: "Autenticação"
description: "Aprenda como obter e usar API Keys para autenticar suas requisições na API Upay. Guia completo com exemplos práticos"
---
...
Ambos os formatos são aceitos. Recomendamos o uso do formato Bearer Token por ser mais padrão.
...
<CardGroup cols={2}>
  ...
  <Card title="Início Rápido" icon="rocket" href="/pages/quickstart">
