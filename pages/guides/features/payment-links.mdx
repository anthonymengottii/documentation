...
| `amountCents` | number | Valor em centavos. Exemplo: 9900 = R$ 99,00. Mínimo: 100 (R$ 1,00). | - |
...
| `interestRate` | number | Taxa de juros mensal (%). Aplicada após parcelas sem juros. | 0 |
