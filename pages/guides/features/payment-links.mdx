...
```bash
curl -X GET "https://api.upay-sistema.onrender.com/api/v1/payment-links?page=1&limit=20" \
  -H "Authorization: Bearer SUA_API_KEY"
```
...
```bash
curl -X GET "https://api.upay-sistema.onrender.com/api/v1/payment-links/{id}" \
  -H "Authorization: Bearer SUA_API_KEY"
```
...
```bash
curl -X PATCH "https://api.upay-sistema.onrender.com/api/v1/payment-links/{id}" \
  -H "Authorization: Bearer SUA_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "title": "Novo Título",
...
```bash
curl -X DELETE "https://api.upay-sistema.onrender.com/api/v1/payment-links/{id}" \
  -H "Authorization: Bearer SUA_API_KEY"
```
