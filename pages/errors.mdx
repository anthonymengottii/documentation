...
- **code**: Código único identificando o tipo de erro (ex: `NOT_FOUND`).
- **timestamp**: Data e hora do erro no formato ISO 8601.
- **path**: O endpoint que originou o erro.
- **details**: (Apenas em ambiente de desenvolvimento) Detalhes específicos sobre erros de validação.
...
<ResponseField name="403 Forbidden" type="error">
  ...
  **Códigos comuns:**
  ...
  - `PAYMENT_METHOD_NOT_ALLOWED`: Método de pagamento desabilitado para sua conta
</ResponseField>
...
<ResponseField name="409 Conflict" type="error">
  ...
  **Códigos comuns:**
  - `DUPLICATE_ENTRY`: O recurso (ou campo único) já existe
